...
### 30 degrees
```{r}
hand_30 <- read.csv("data/hand_30.csv")
...
### 60 degrees
```{r}
hand_60 <- read.csv("data/hand_60.csv")
#ppid from int to chr
...
Load aligned data
```{r}
data_toola <- "data/pen_aligned.csv"
...
data_toolhand <- "data/pen_rotated.csv"
...
data_penr <- "data/pen_rotated.csv"
...
data_toola <- read.csv("data/pen_aligned.csv")
...
data_penr <- read.csv("data/pen_rotated.csv")
...
data_tool <- "data/pen_rotated.csv"
